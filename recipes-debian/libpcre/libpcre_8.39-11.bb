...
# same as debian/pcreposix.patch
# file://fix-pcre-name-collision.patch

DPV = "2:8.39-11"
DPN = "pcre3"

SRC_URI[dsc.md5sum] = "b0187dcfab1401429eee9b2202e3b6ef"
SRC_URI[dsc.sha256sum] = "50738a8e55d4bdc10fd6eecc623170d0657bd15805e630d82bc90d722fcbc435"

inherit debian-package-ng
# override 'S' set by debian-package-ng
S = "${WORKDIR}/pcre-${DEB_SRC_VERSION}"
