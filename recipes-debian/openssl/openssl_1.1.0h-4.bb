...
SRC_URI[dsc.md5sum] = "85d1843378b53636025afd27d68bd12c"
SRC_URI[dsc.sha256sum] = "85ebb39d96f5516bf12e1f61052034e4c80475088102b536ae8b8a1d2c04dd21"


#S = "${WORKDIR}/openssl-${PV}"

inherit lib_package multilib_header ptest debian-package-ng
...
do_install_ptest() {
        cp -r * ${D}${PTEST_PATH}
        # for debian-package-ng
        rm -rf ${D}${PTEST_PATH}/debian
